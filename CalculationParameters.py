...
class CalculationParameters:
    ...
    """
    def from_angles_and_calculation_method(self, fajr_angle: float, isha_angle: float, calculation_method: CalculationMethod):
    ...
    param method the calculation method to use
    """
    def from_fajr_angle_isha_interval_and_calculation_method(self, fajr_angle: float, isha_interval: int, calculation_method: CalculationMethod):
    ...
    def get_parameters_from_method(self, calculation_method: CalculationMethod):
        if calculation_method == CalculationMethod.MUSLIM_WORLD_LEAGUE:
            return self.from_angles_and_calculation_method(18.0, 17.0, calculation_method).with_method_adjustments(PrayerAdjustments(0, 0, 1, 0, 0, 0))

        elif calculation_method == CalculationMethod.EGYPTIAN:
            return self.from_angles_and_calculation_method(19.5, 17.5, calculation_method).with_method_adjustments(PrayerAdjustments(0, 0, 1, 0, 0, 0))
        
        elif calculation_method == CalculationMethod.KARACHI:
            return  self.from_angles_and_calculation_method(18.0, 18.0, calculation_method).with_method_adjustments(PrayerAdjustments(0, 0, 1, 0, 0, 0))
        
        elif calculation_method == CalculationMethod.UMM_AL_QURA:
            return self.from_fajr_angle_isha_interval_and_calculation_method(18.5, 90, calculation_method)
        
        elif calculation_method == CalculationMethod.DUBAI:
            return self.from_angles_and_calculation_method(18.2, 18.2, calculation_method).with_method_adjustments(PrayerAdjustments(0, -3, 3, 3, 3, 0))
        
        elif calculation_method == CalculationMethod.MOON_SIGHTING_COMMITTEE:
            return self.from_angles_and_calculation_method(18.0, 18.0, calculation_method).with_method_adjustments(PrayerAdjustments(0, 0, 5, 0, 3, 0))
        
        elif calculation_method == CalculationMethod.NORTH_AMERICA:
            return self.from_angles_and_calculation_method(15.0, 15.0, calculation_method).with_method_adjustments(PrayerAdjustments(0, 0, 1, 0, 0, 0))
        
        elif calculation_method == CalculationMethod.KUWAIT:
            return self.from_angles_and_calculation_method(18.0, 17.5, calculation_method)
        
        elif calculation_method == CalculationMethod.QATAR:
            return self.from_fajr_angle_isha_interval_and_calculation_method(18.0, 90, calculation_method)

        elif calculation_method == CalculationMethod.SINGAPORE:
            return self.from_angles_and_calculation_method(20.0, 18.0, calculation_method).with_method_adjustments(PrayerAdjustments(0, 0, 1, 0, 0, 0))

        elif calculation_method == CalculationMethod.UOIF:
            return self.from_angles_and_calculation_method(12.0, 12.0, calculation_method)
